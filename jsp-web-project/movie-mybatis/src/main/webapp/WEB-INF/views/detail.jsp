...
<body><header class="header-container">
		...
		<!-- 영화 정보 출력하기 -->
		<div class="container my-3 movie-container" style="background-color: #f2f2f2;">
			<div class="movie-info p-3 d-flex justify-content-between m-6">
				<!-- 포스터 영역 -->
				<div class="me-3">
					<img src="/movieImage/${movie.getPoster()}" alt="poster" class="img-fluid" />
				</div>
				<!-- 영화 정보 영역 -->
				<div>
					<p>
					...
					<!-- 수정/삭제 버튼 영역 -->
					<div class="movie-buttons d-flex">
						<button class="btn btn-outline-warning collapse-button"
							data-bs-toggle="collapse" data-bs-target="#updateMovie"
							aria-expanded="false" aria-controls="updateMovie" style="margin-right: 10px;">
							수정
						</button>
						<a href="/movie/movieList?action=deleteMovie&id=${movie.getId()}" class="btn btn-outline-danger">
							삭제
						</a>
					</div>
				</div>
